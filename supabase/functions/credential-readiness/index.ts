...
Deno.serve(async (req: Request) => {
  ...
  // The authenticated key-class receipt is deliberately written before the
  // duplicate short-circuit, so idempotent retries can still satisfy the
  // modern-server-key verification gate without scanning credentials again.
  try {
